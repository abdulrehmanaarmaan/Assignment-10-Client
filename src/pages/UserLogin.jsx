...
const UserLogin = () => {
    const { login, googleLogin, setError, error, loginToast } = use(AuthContext);
    ...
    return (
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl m-auto">
            <div className="card-body">
                ...
                <p className='text-center'>Don't have an account? <NavLink to='/user-registration' className='hover:cursor-pointer hover:text-blue-700 hover:underline'>Register</NavLink></p>
            </div>
