...
const UserRegistration = () => {
    const { googleLogin, setUser, register, error, setError } = use(AuthContext);
    ...
    return (
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl m-auto">
            <div className="card-body">
                ...
                <p className='text-center'>Already have an account? <NavLink to='/user-login' className='hover:cursor-pointer hover:text-blue-700 hover:underline'>Login</NavLink></p>
            </div>
